...
print("Valor que se encuentara en el indice 1: ", dias[1])
print("Valor que se encuentran desde el indice inicial 0 hasta 2: " , dias[:3]) #Del cero al tres
print("Valores que se encuentran desde el indice 3 hasta 6 que es el indice final: ", dias[3:])
print("Valores desde el indicee 3 hasta el indice 4", dias[3:5])
